...
essential here, as it provides a framework for expressing the
divergence and curl operators in arbitrary coordinates. We develop this
framework in the following subsections.

\subsection{Divergence and curl}

In Cartesian coordinates and using Einstein notation, the divergence operator
takes the form
\begin{equation*}
\nabla\cdot \boldsymbol{V} = \partial_i V^i.
\end{equation*}

We can express this in a coordinate-free manner. For a general coordinate system
with metric tensor \(g\), the divergence operator becomes
